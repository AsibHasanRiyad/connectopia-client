...
//                     <input type="text" className="px-6 w-[50vw] py-2 text-gray-700 bg-white border rounded-md       dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring sm:mx-2" placeholder="Enter tags" />
