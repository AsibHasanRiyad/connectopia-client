...
const Contact = () => {
  const handelMessage = (e) => {
    e.preventDefault();
    toast.success("Thankyou for your message. We'll reach you soon.");
  };
  return (
    <section className="">
      <div className="container px-6 py-12 mx-auto">
        <div className="lg:flex lg:items-center lg:-mx-6">
          <div className="lg:w-1/2 lg:mx-6">
            <h1 className="text-2xl font-semibold text-gray-100 capitalize dark:text-white lg:text-3xl">
          ...
          <div className="mt-8 lg:w-1/2 lg:mx-6">
            <div className="w-full px-8 py-10 mx-auto overflow-hidden bg-transparent rounded-lg   lg:max-w-xl ">
              ...
              <form className="mt-6">
                ...
                <div className="w-full mt-6">
                  ...
                  <textarea
                    className="block w-full h-32 px-5 py-3 mt-2 text-gray-300 placeholder-gray-400 bg-white border border-gray-200 rounded-md md:h-48 dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40"
                    placeholder="Message"
                    required
                  ></textarea>
                </div>
