...
const AnnouncementPage = () => {
    ...
    if (announcement.length === 0) {
        return  <div className="container px-6 py-16 mx-auto">
        <div className="items-center lg:flex">
            <div className="w-full lg:w-1/2">
                <div className="lg:max-w-lg">
                    <h1 className="text-3xl font-semibold text-gray-100 dark:text-white lg:text-5xl">No <span className="text-green-500">Announcement</span> available right now</h1>
                </div>
            </div>
