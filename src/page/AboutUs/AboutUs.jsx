        ...
        <div className="container px-6 py-10 mx-auto">
          <div className="lg:flex lg:items-center">
            <div className="w-full space-y-12 lg:w-1/2 ">
              <div>
                <h1 className="text-2xl font-semibold text-gray-100 capitalize lg:text-3xl dark:text-white">
                  explore about <br /> Connectopia
                </h1>
                <p className=" text-gray-300 mt-2">
                  Welcome to Connectopia, where meaningful connections happen!
                  Our platform is dedicated to providing a space for individuals
                  to share ideas, engage in discussions, and build a vibrant
                  online community
                </p>
              ...
              <div className="md:flex md:items-start md:-mx-4">
                ...
                <div className="mt-4 md:mx-4 md:mt-0">
                  <h1 className="text-xl font-semibold text-gray-300 capitalize dark:text-white">
                    Mission Statement:
                  </h1>

                  <p className="mt-3 text-gray-400 dark:text-gray-300">
                    Our mission at Connectopia is to create a diverse and
                    inclusive online space where people from all walks of life
              ...
              <div className="md:flex md:items-start md:-mx-4">
                ...
                <div className="mt-4 md:mx-4 md:mt-0">
                  ...
                  <p className="mt-3 text-gray-400 dark:text-gray-300">
                    Discover the power of Connectopia with features like
                    real-time commenting, customizable user profiles, and a
                    seamless interface designed to enhance your online
              ...
              <div className="md:flex md:items-start md:-mx-4">
                ...
                <div className="mt-4 md:mx-4 md:mt-0">
                  ...
                  <p className="mt-3 text-gray-400 dark:text-gray-300">
                    At Connectopia, we believe in fostering a community where
                    respect and open-mindedness thrive. We encourage diverse
                    perspectives and celebrate the richness that each member
            ...
            <div className="hidden lg:flex lg:items-center lg:w-1/2 lg:justify-center">
              <img
                ...
                src="https://i.ibb.co/6rgDFxd/Pngtree-teamwork-concept-people-work-together-6667639-1.png"
                alt=""
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-8 md:grid-cols-6 lg:grid-cols-5">
            <div className="flex items-center justify-center col-span-1 md:col-span-2 lg:col-span-1">
              <svg
                className="h-12 text-gray-400 fill-current dark:text-gray-300"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 266 100"
              >
            ...
            <div className="flex items-center justify-center col-span-1 md:col-span-2 lg:col-span-1">
              <svg
                className="h-10 text-gray-400 fill-current dark:text-gray-300"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 316 60"
              >
            ...
            <div className="flex items-center justify-center col-span-1 md:col-span-2 lg:col-span-1">
              <svg
                className="h-8 mt-2 text-gray-400 fill-current dark:text-gray-300"
                viewBox="0 0 398 120"
                xmlns="http://www.w3.org/2000/svg"
              >
                <g>
            ...
            <div className="flex items-center justify-center col-span-1 md:col-span-3 lg:col-span-1">
              <svg
                className="h-5 mt-1 text-gray-400 fill-current dark:text-gray-300"
                xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="flex items-center justify-center col-span-2 md:col-span-3 lg:col-span-1">
              <svg
                className="h-8 text-gray-400 fill-current dark:text-gray-300"
